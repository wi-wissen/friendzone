...
@section('content')
	...
	<a style="float:right;" class="btn btn-default" href="http://phpmyadmin.app/?pma_username=friendzone_{{ Auth::user()->id }}&pma_password={{ Auth::user()->db_password }}" role="button">Login phpMyAdmin</a>
	<h1>{{ $user->name }}</h1>
